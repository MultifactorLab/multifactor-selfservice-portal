...
public class RedirectToCredValidationAfter2FaStoryV2
{
    private readonly ILogger<RedirectToCredValidationAfter2FaStoryV2> _logger;
    private readonly IApplicationCache _applicationCache;
    private readonly IMultifactorIdpApi _idpApi;
    private readonly SafeHttpContextAccessor _contextAccessor;

    public RedirectToCredValidationAfter2FaStoryV2(
        IApplicationCache applicationCache,
        ILogger<RedirectToCredValidationAfter2FaStoryV2> logger,
